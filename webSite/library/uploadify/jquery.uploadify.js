...
(function($) {
    ...
    var handlers = {
        ...
        onDialogOpen: function() {
            ...
            this.queueData.errorMsg = '一些文件没有加入到队列:';
        ...
        onSelect: function(file) {
            ...
            if (settings.itemTemplate == false) {
                settings.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">\
					...
					<span title="${fileOldName}" class="fileName">${fileName} (${fileSize})</span><span class="data"></span>\
                ...
                switch (errorCode) {
                    case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
                        if (settings.queueSizeLimit > errorMsg) {
                            this.queueData.errorMsg += '\n选择的文件数超过剩余上传限制' + errorMsg + '个.';
                        } else {
                            this.queueData.errorMsg += '\n选定的文件数超过了队列的最大限制 ' + settings.queueSizeLimit + '个.';
                        }
                        break;
                    ...
                    case SWFUpload.QUEUE_ERROR.ZERO_BYTE_FILE:
                        ...
                        break;
                    case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                        this.queueData.errorMsg += '\n选定的文件 "' + file.name + '" 是不被接受的文件类型 ' + settings.fileTypeDesc + '.';
                        break;
                }
            }
